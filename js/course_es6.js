...
class Course {
	constructor(course_id,course_name,course_year,course_type,course_description,course_student_id){
		if(this.validate(course_id,course_name,course_year,course_type,course_description,course_student_id)){
	...
	validate(course_id,course_name,course_year,course_type,course_description,course_student_id){
		if(course_id==''){
			console.log('Please enter course id.');
			return false;
		}
		if(course_name==''){
		...
		if(course_student_id==''){
			console.log('Please enter COURSE STUDENT ID.');
			return false;
		}
	...
	editCourse(course_id,course_name,course_year,course_type,course_description,course_student_id){
